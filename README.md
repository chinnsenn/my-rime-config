...
- **智能纠错**: 支持拼音容错和笔画提示
- **中英混输**: 无需切换直接输入英文，中文候选优先显示
- **符号输入**: 支持符号键直接键入候选，或输入编码后选择符号
- **快速翻页**: 逗号上翻/句号下翻，浏览候选更高效

### 日文输入特色
- **长音输入**: `ka-` 或 `kaL` 都可输入「カー」
- **片假名**: Shift+字母强制片假名
- **模式切换**: `あ/A` 切换日文/英文模式
- **假名预览**: Buffer 智能识别罗马字编码，实时显示对应假名 [こんにちは]
- **中日混输**: 无需切换输入法，中日文候选智能混合显示
